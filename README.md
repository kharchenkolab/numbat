...
```
**Note**: To avoid memory issues associated with OpenMP, **please set `export OMP_NUM_THREADS=1` in your bash shell before starting R/Rscript**. We're currently looking for a solution to control the behavior of OpenMP within R.
