...
RcppExport SEXP _numbat_viterbi_allele_compute(SEXP log_deltaSEXP, SEXP logprobSEXP, SEXP logPiSEXP, SEXP nSEXP, SEXP mSEXP, SEXP nuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(viterbi_allele_compute(log_delta, logprob, logPi, n, m, nu));
    return rcpp_result_gen;
END_RCPP
}
// CgetQ
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_numbat_viterbi_allele_compute", (DL_FUNC) &_numbat_viterbi_allele_compute, 6},
