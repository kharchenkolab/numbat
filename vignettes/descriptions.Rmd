...
#### Source data files
- [`bulk_subtrees_{i}.tsv.gz`](#pseudobulk-profiles): subtree pseudobulk data based on current cell lineage tree
- [`segs_consensus_{i}.tsv.gz`](#consensus-segments): consensus segments from subtree pseudobulk HMMs
- [`bulk_clones_{i}.tsv.gz`](#pseudobulk-profiles): clone-leve pseudobulk data based on current cell lineage tree
...
- [`bulk_clones_final.tsv.gz`](#pseudobulk-profiles): clone-leve pseudobulk data based on final cell lineage tree
...
- `bulk_subtrees_retest_{i}.tsv.gz`: subtree pseudobulk after retesting CNV states
