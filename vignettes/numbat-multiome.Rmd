...
The second way, is for each cell to have a unionized feature space for all modalities. This can include summing the counts across ATAC and RNA.
PS. We have gotten results through some experimentation, but this has not yet been benchmarked. We recommend your references to also be summed multiome data. 
