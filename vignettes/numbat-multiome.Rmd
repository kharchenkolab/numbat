...
This vignette provides a guide to preparing input data for running Numbat-multiome. which extends the capabilities of Numbat to perform CNV infer-
ence from accessible chromatin profiles (through scATAC-seq
data) alone, and combined with scRNA-seq in an integrated manner. 
