...
plot_bulks = function(bulk_all, min_depth = 8) {
    ...
    panel = wrap_plots(plot_list, ncol = 1, guides = 'collect')
...
tree_heatmap2 = function(joint_post, gtree, cell_dict = NULL, legend = T) {
